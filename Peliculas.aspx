<%@ Page Title="" Language="C#" MasterPageFile="~/Cinestar.Master" AutoEventWireup="true" CodeBehind="Peliculas.aspx.cs" Inherits="Cinestar.Peliculas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="contenido-pelicula">
        <div class="datos-pelicula">
            <h2>Locos de Amor 2 (+14) (HD - Doblada)</h2>
            <br />
        ...
        <img src="img/pelicula/10.jpg" width="160" height="226" /><br />
        <br />
    </div>
</asp:Content>
